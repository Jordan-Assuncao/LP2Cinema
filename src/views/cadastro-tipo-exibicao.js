...
function CadastroFormatoExibicao(){
    ...
    async function buscar() {
      ...
      setFormatoExibicao(dados.formatoExibicao);
      setDescricao(dados.descricao);
      setFormatoUnico(dados.formatoUnico  ? 'Sim' : 'Não');
    }
          ...
          <div className='row'>
            <div className='col-lg-12'>
              <div className='bs-component'>
                ...
                <FormGroup label='Formato único? *' htmlFor='inputFormatoUnico'>
                  <input
                    type='text'
                    id='inputFormatoUnico'
                    value={formatoUnico}
                    className='form-control'
                    name='formatoUnico'
                    onChange={(e) => setFormatoUnico(e.target.value)}
                  />
                </FormGroup>
